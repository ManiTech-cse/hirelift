...
// Company logos mapping - HIGH QUALITY REAL LOGOS (like Chrome search results)
const COMPANY_LOGOS: { [key: string]: string } = {
  ...
  'JP Morgan': 'https://upload.wikimedia.org/wikipedia/commons/4/44/JPMorgan_Chase_Bank.svg',
  'Morgan Stanley': 'https://upload.wikimedia.org/wikipedia/commons/2/26/Morgan_Stanley_Logo_1.svg',
  ...
  'HCL': 'https://upload.wikimedia.org/wikipedia/commons/c/c0/HCLTech_logo.svg',
  'Cognizant': 'https://upload.wikimedia.org/wikipedia/commons/6/6a/Cognizant_logo_2022.svg',
};
